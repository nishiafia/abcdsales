<template>
 ...
 Search </button>
                ...
                <form @submit.prevent="createIncomingPayment()" id="incomingpayment" >
                  ...
                  <tr v-for="(porder,k) in porders" :key="k">
                      <td  colspan="8" v-if="porder.totalamount !== 0">
                          <table class="incomingtable">
                            ...
                            <td class="incomingtabletd">{{ porder.totalamount | toCurrency}}</td>
                            <td class="incomingtabletd"><input type="text" name="paidamount"  v-model="porder.paidamount" readonly class="transactioninput"  />+<input type="text" name="paidamountcurrent"  v-model="porder.paidamountcurrent" readonly class="transactioninput" />
                            </td>
                            <td class="incomingtabletd" v-if="porder.paidamount !== porder.totalamount"> 
                            ...
                            <td class="incomingtabletd"><input type="text" name="dueamount"  v-model="porder.dueamount" readonly class="transactioninput"  />
                            </td>
                                </tr>
...
import 'vue-phone-number-input/dist/vue-phone-number-input.css';
    export default {
        ...
        methods: {
          ...
          checkConfirmbutton(ids,event,k){
      ...
      getCustomerId(event)
         {
          ...
          createIncomingPayment: function (e) {
            ...
            axios.post('/createIncomingPayment', {accountInfo: accountDetails, ordersList: allCheckedOrders})
            .then((response) => {
