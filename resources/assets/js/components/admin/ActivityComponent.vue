              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                  ...
                  <tr v-for="commdata in activities.data" :key="commdata.id">
                    ...
                    <td>
                        <a href="/#/activity" title="Edit" data-id="commdata.id" @click="editModalWindow(commdata)">
    ...
    export default {
       ...
       return char;
        ...
        methods: {
          ...
          console.log("category=",theItem.telephone)
        ...
        loadActivity(page) {
            ...
            axios.get('api/communication?page=' + page, {headers})
            .then( response =>{
